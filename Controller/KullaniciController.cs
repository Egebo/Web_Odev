...
namespace Web_Odev.Controllers
{
    public class KullaniciController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Ad,Soyad,Email,Sifre")] Kullanici kullanici)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Ad,Soyad,Email,Sifre")] Kullanici kullanici)
        {
            if (id != kullanici.Id)
            {
                return NotFound();
