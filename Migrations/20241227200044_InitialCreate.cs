    ...
    public partial class InitialCreate : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_Kuaförler", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    KuaförId = table.Column<int>(type: "int", nullable: true)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_Calisanlar", x => x.Id);
                    table.ForeignKey(
                        name: "FK_Calisanlar_Kuaförler_KuaförId",
                        column: x => x.KuaförId,
                        principalTable: "Kuaförler",
                        principalColumn: "Id");
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Hizmetler_Kuaförler_KuaförId",
                        column: x => x.KuaförId,
                        principalTable: "Kuaförler",
                        principalColumn: "Id");
                });
            ...
            migrationBuilder.InsertData(
                table: "Kuaförler",
                columns: new[] { "Id", "Ad", "Adres", "CalismaSaatleri" },
                values: new object[] { 1, "Örnek Kuaför", "Örnek Adres", "09:00-18:00" });

            migrationBuilder.CreateIndex(
                name: "IX_Calisanlar_KuaförId",
                table: "Calisanlar",
                column: "KuaförId");

            migrationBuilder.CreateIndex(
                name: "IX_Hizmetler_KuaförId",
                table: "Hizmetler",
                column: "KuaförId");
